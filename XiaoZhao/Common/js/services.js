...
xiaozhao_services.factory("StaticResource",function(){
	...
	var Resource = {
		index_page:{
			_Carousel: [{
							url:rootAddress + "img/Carousel/0.jpg",
							statement: "",
							mode:true
						},{
							...
							url:rootAddress + "img/Carousel/4.jpg", 
							statement: "",
							mode:false
						},{
							url:rootAddress + "img/Carousel/5.jpg",
							statement: "",
							mode:false
						}],
			GoodCompanyPartA: [
		...
		Smanagement:{
			header: rootAddress + "partials/management/PageHeader.html",
			footer: rootAddress + "partials/management/PageFooter.html",
		...
		createJob:{
			money:["待定","3000-5000元","5000-8000元","8000-10000元","10000-15000元"]
		},
		CompanyInfo:{
			companyScale:["0-10人","10-50人","50-100人","100-300人","300人以上"],
			companyType:["国有企业","私人企业","外资企业"]
		...
		PageHeader:{
			TopLogo: rootAddress + "img/top-logo.jpg",
			css: rootAddress + "css/PageHeader.css"
		},
		PageFooter:{
			css: rootAddress + "css/PageFooter.css"
		},
		alertController:{
			loading:rootAddress + "img/loading.gif"
		}
