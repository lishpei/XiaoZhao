...
//upload photos
 function companyAuth($scope,$timeout,$cookieStore,$rootScope,$upload,CompanyInfo,PhotoManager){
  ...
  function Cmanagement($scope,$location,$cookieStore,templateName,StaticResource,CompanyInfo){
  ...
  //just for footer which is used in management realated page
  function Managermentfooter($scope,StaticResource){
      $scope.ResourceURLs = StaticResource.getResourceURLs('Managermentfooter');
  }